...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/cottage/type/{cottageType}/available-dates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.CottageAvailablePeriod"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.AvailablePeriodDTO"
                            }
                        }
                    },
                    "400": {
        ...
        "/cottage/{name}/booking": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "IsValidBooking request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ConfirmationDto"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/cottage/{name}/booking/{bookingId}": {
            "delete": {
    ...
    "definitions": {
        "domain.CottageAvailablePeriod": {
            ...
            "properties": {
                ...
                "periods": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ValidPeriod"
                    }
                }
            }
        },
        ...
        "dto.Dto": {
            ...
            "properties": {
                ...
                "details": {
                    "$ref": "#/definitions/dto.DetailsDto"
                },
                "name": {
                    "type": "string"
                },
